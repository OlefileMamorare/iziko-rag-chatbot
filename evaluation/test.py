...
class TestQuestion(BaseModel):
    ...
    keywords: list[str] = Field(description="Keywords expected to appear in retrieved context")
    reference_answer: str = Field(description="The reference (gold) answer for this question")
